...
export default {
  ...
  data() {
    return {
      activeIndex: 0,
      collections: [
        { subtitle: 'COLLECTION 01', title: '秘境之森<br>凝视万物生灵', desc: '探寻林间的微光与翠意，<br>感受大自然最原始的呼吸与宁静。', image: '/fengmian.png' },
        { subtitle: 'COLLECTION 03', title: '极寒构造<br>冰雪中的物理美学', desc: '在零下三十度的冰雪巨构中，<br>捕捉极致的冰棱刻线与冷酷之美。', image: '/xuewu.png' },
