...
export default {
  ...
  data() {
    return {
      activeIndex: 0,
      collections: [
        { subtitle: 'COLLECTION 01', title: '光影之间<br>记录世界的呼吸', desc: '十年光阴，穿行于城市与旷野之间，<br>用镜头收藏那些转瞬即逝的真实。', image: '/DSC_6174.jpg' },
        { subtitle: 'COLLECTION 02', title: '秘境之森<br>凝视万物生灵', desc: '探寻林间的微光与翠意，<br>感受大自然最原始的呼吸与宁静。', image: '/DSC_6510.jpg' },
